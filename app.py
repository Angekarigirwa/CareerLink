...
def rwandan_jobs():
    ...
    # Filter jobs by Rwandan companies
    rwandan_companies = [
        'Andela Rwanda', 'KCB Bank Rwanda', 'Marriott Hotel Kigali', 
        'Mara Phones Rwanda', 'Zipline Rwanda', 'Rwanda Energy Group (REG)',
        'MTN Rwanda', 'RwandAir', 'Bank of Kigali', 'Radisson Blu Hotel Kigali'
    ]
    
    query = query.filter(Job.company.in_(rwandan_companies))
